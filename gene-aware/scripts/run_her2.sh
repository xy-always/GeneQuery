...
BATCH_SIZE=30
PROJECT_ROOT=path
DATA_DIR=$PROJECT_ROOT/data/her2st
...
do
    echo 'SEED:'$seed
    OUTPUT_DIR=$PROJECT_ROOT/checkpoints_gene_wise/$DATA_NAME-$MODEL_TYPE-$IMAGE_ENCODER-$GENE_ENCODER_TYPE-dim$GENE_PROJECTION_DIM-mlp$NUM_PROJECTION_LAYERS-nlayer$N_LAYER-epoch$EPOCHS-lr$LR-dataset$DATASET-fold$FOLD-$seed-GptDescription
