#!/bin/bash
#SBATCH --job-name=her2_chatgpt_add
#SBATCH --mem=230G
#SBATCH --gres=gpu:4
#SBATCH --exclusive
...
do
    echo 'FOLD:'$fold
    OUTPUT_DIR=$PROJECT_ROOT/checkpoints_wsi/$DATA_NAME-$MODEL_TYPE-$IMAGE_ENCODER-$GENE_ENCODER_TYPE-dim$GENE_PROJECTION_DIM-mlp$NUM_PROJECTION_LAYERS-epoch$EPOCHS-lr$LR-crossvalidation-fold$fold-40percentgene
